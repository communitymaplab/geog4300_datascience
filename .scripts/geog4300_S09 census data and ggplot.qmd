---
title: "Summarising and visualizing census data with ggplot"
...
```{r}
var_select<-v21 %>% filter(substr(name,1,6)=="B19013")

cty_medinc<-get_acs(geography="county",variables=var_select$name,year=2021)
```
...
******ADD SECTION HERE ON SUMMARIZING THE DATA********
...
--
### You try it!
* Look at the ggplot cheat sheet. Visualize these data with two other geom types listed on that sheet. Which work best? How do their stories differ? What other parts of the visualization can you customize?
